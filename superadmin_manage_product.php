        ...
        <div class="product-list">
            ...
            <table class="product-table" border="1" width="700px" height="100px">
                ...
                <tr>
                    ...
                    <td><a href="superadmin_edit_product.php?edit&procode=<?php echo $row['product_code']; ?>">Edit</a></td>
                    <td><a href="superadmin_delete_product.php?del&procode=<?php echo $row['product_code']; ?>" onclick="return confirmation();">Delete</a></td>
                </tr>
                <?php
                }
                ?>
            ...
            <table class="product-table" border="1" width="700px" height="100px">
                ...
                <tr>
                    ...
                    <td><a href="superadmin_edit_ticket.php?edit&procode=<?php echo $row['ticketID']; ?>">Edit</a></td>
                    <td><a href="superadmin_delete_ticket.php?del&ticket_search=<?php echo $row['ticketID']; ?>" onclick="return confirmation();">Delete</a></td>
                </tr>
                <?php
                }
                ?>
            ...
            <div class="edit-buttons">
                ...
                <a class="edit_btn" href="superadmin_add_product.php">Add Product /</a>
                <a class="edit_btn" href="superadmin_add_ticket.php">Add Ticket</a>
            </div>
        </div>
    </div>    
</body>
