...
if(isset($_REQUEST['pwdrst']))
{
  ...
  if($pwd == $cpwd)
  {
    $reset_pwd = mysqli_query($connection,"update user set password='$pwd' where email='$email'");
    if($reset_pwd>0)
    {
...
if($_GET['secret'])
{
  ...
  $check_details = mysqli_query($connection,"select email from user where email='$email'");
