...
if (isset($_GET['edit']) && isset($_GET['procode'])) {
    ...
    if (!$row) {
        header("Location: superadmin_manage_product.php");
        exit;
    }
}
...
<body>
    <div id="container">
        ...
        <div class="product-list">
            <h2>Edit Product</h2>
            <form action="superadmin_edit_product.php?edit&procode=<?php echo $product_code; ?>" method="post" enctype="multipart/form-data">
                <table>
                    <tr>
                        <td>Product Code:</td>
