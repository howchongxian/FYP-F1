    ...
    if (strlen($password) < 8) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                // Use JavaScript to redirect instead of header() to avoid headers already sent warning
                echo "<script>window.location.href = 'admin.php?msg=New record created successfully';</script>";
                exit();
            } else {
